...
{
    /// <inheritdoc />
    public partial class TableNews : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroColegiatura = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UniversidadEgresado = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicamentosActuales = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HistorialMedico = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    EstaActivo = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoCitaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MotivoConsulta = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctores_NumeroColegiatura",
                table: "Doctores",
